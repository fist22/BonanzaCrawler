...
import dvds_movies_product_details
...
def collect_data():
    ...
    prod_urls_file = open(constants.file_names["dvds_movies"]["product"]).read().splitlines()
    ...
    ThreadPool().map(dvds_movies_product_details.get_details, prod_url_info)
