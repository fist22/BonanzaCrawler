...
import business_product_details
...
def collect_data():
    ...
    prod_urls_file = open(constants.file_names["business"]["product"]).read().splitlines()
    ...
    ThreadPool().map(business_product_details.get_details, prod_url_info)
