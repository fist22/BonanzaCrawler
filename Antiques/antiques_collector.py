...
import antiques_product_details
...
def collect_data():
    ...
    prod_urls_file = open(constants.file_names["antiques"]["product"]).read().splitlines()
    ...
    ThreadPool().map(antiques_product_details.get_details, prod_url_info)
