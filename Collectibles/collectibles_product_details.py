...
def to_file(prod):
    products = open(constants.file_names["collectibles"]['output'], 'a')
...
def get_details(prod_url_info):
    ...
    try:
        product_original_price = product_source.find('span', {'class': 'nondiscount_price'}).text.replace('$',
                                                                                                          '').replace(
            ',', '')
    ...
    try:
        prod_price = product_source.find_all('div', {'class': 'item_price'})[0].text.strip().replace('$', '').replace(
            ',', '').encode('utf8', 'ignore')
    except:
        prod_price = "NA"
    ...
    try:
        shop_rating = product_source.find_all('div', {'class': 'feedback_rating'})[0].find('a').text.replace(
            '%  rating', '').encode('utf8', 'ignore')
    except:
        shop_rating = "NA"
    ...
    try:
        return_policy = product_source.find_all('div', {'class': 'item_listing_additional_details_section'})[
            1].text.strip()
    ...
    try:
        shipping_policy = product_source.find_all('div', {'class': 'item_listing_additional_details_section'})[
            0].text.strip()
    ...
    try:
        ...
        for row in range(0, no_of_rows, 2):
            ...
            if 'Quantity' in key:
                ...
                product_parameters["Specifications"]["Format"] = value
            elif 'Genre' in key:
                product_parameters["Specifications"]["Genre"] = value
            elif 'UPC' in key:
                product_parameters["UPC"] = value
            elif 'Director' in key:
                product_parameters["Specifications"]["Director"] = value
            elif 'Leading Role' in key:
                product_parameters["Specifications"]["Leading Role"] = value
            elif 'EAN' in key:
                product_parameters["EAN"] = value
            elif 'Region Code' in key:
                product_parameters["Specifications"]["Region Code"] = value
            elif 'Season' in key:
                product_parameters["Specifications"]["Season"] = value
            elif 'Brand' in key:
                product_parameters["Brand"] = value
            elif 'MPN' in key:
                product_parameters["MPN"] = value
            elif 'Studio' in key:
                product_parameters["Specifications"]["Studio"] = value
            elif 'Actor' in key:
                product_parameters["Highlights"]["Actors"] = value
            elif 'Writer' in key:
                product_parameters["Highlights"]["Writer"] = value
            elif 'Producer' in key:
                product_parameters["Highlights"]["Producers"] = value
            elif 'Language' in key:
                product_parameters["Specifications"]["Language"] = value
            elif 'Subtitles' in key:
                product_parameters["Highlights"]["Subtitles"] = value
            elif 'Edition' in key:
                product_parameters["Specifications"]["Edition"] = value
            elif 'Release' in key:
                product_parameters["Specifications"]["Relase Date/Year"] = value
            elif 'Reviews' in key:
                continue
