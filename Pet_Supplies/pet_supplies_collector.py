...
import pet_supplies_product_details
...
def collect_data():
    ...
    prod_urls_file = open(constants.file_names["pet_supplies"]["product"]).read().splitlines()
    ...
    ThreadPool().map(pet_supplies_product_details.get_details, prod_url_info)
