...
import everything_else_product_details
...
def collect_data():
    ...
    prod_urls_file = open(constants.file_names["everything_else"]["product"]).read().splitlines()
    ...
    ThreadPool().map(everything_else_product_details.get_details, prod_url_info)
