...
def to_file(prod):
    products = open(constants.file_names["entertainment"]['output'], 'a')
...
def get_details(prod_url_info):
    ...
    try:
        ...
        for row in range(0, no_of_rows, 2):
            ...
            if 'Quantity' in key:
                ...
                product_parameters["ISBN"] = value
            elif 'Manufacturer' in key:
                product_parameters["Specifications"]["Manufacturer"] = value
            elif 'Country' in key:
                product_parameters["Specifications"]["Country of Manufacture"] = value
            elif 'Subject' in key:
                product_parameters["Specifications"]["Subject"] = value
            elif 'Topic' in key:
                product_parameters["Specifications"]["Topic"] = value
            elif 'Height' in key:
                ...
                product_parameters["Specifications"]["Length"] = value
            elif 'Release' in key:
    ...
    # print prod_name, prod_price, seller_name
    # print description
