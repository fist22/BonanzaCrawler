...
def collect_data():
    ...
    prod_urls_file = open(constants.file_names["art"]["product"]).read().splitlines()
    ...
    ThreadPool().map(art_product_details.get_details, prod_url_info)
