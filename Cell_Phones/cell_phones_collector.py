...
import cell_phones_product_details
...
def collect_data():
    ...
    prod_urls_file = open(constants.file_names["cell_phones"]["product"]).read().splitlines()
    ...
    ThreadPool().map(cell_phones_product_details.get_details, prod_url_info)
