...
def collect_data():
    ...
    prod_urls_file = open(constants.file_names["baby"]["product"]).read().splitlines()
    ...
    ThreadPool().map(baby_product_details.get_details, prod_url_info)
