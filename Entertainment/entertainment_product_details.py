...
def get_details(prod_url_info):
    ...
    try:
        ...
        print 'Error: Could not get product name'
        prod_name = 'NA'
    ...
    try:
        ...
        for row in range(0, no_of_rows, 2):
            ...
            if 'Quantity' in key:
                ...
                product_parameters["Specifications"]["Contry of Manufacture"] = value
            elif 'MPN' in key:
                product_parameters["MPN"] = value
            elif 'genre' in key:
                product_parameters["Specifications"]["Genre"] = value
            elif 'ASIN' in key:
                product_parameters["ASIN"] = value
            elif 'SKU' in key:
                product_parameters["SKU"] = value
            elif 'Director' in key:
                product_parameters["Specifications"]["Director"] = value
            elif 'Year' in key:
                product_parameters["Specifications"]["Year"] = value
            elif 'Brand' in key:
                product_parameters["Brand"] = value
            elif 'UPC' in key:
                product_parameters["UPC"] = value
            elif 'Speed' in key:
                product_parameters["Specifications"]["Speed"] = value
            elif "Sleeve Grading" in key:
                product_parameters["Highlights"]["Sleeve Grading"] = value
            elif 'Record Grading' in key:
                product_parameters["Highlights"]["Record Grading"] = value
            elif 'Title' in key:
                product_parameters["Specifications"]["Title"] = value
            elif 'is_autographed' in key:
                product_parameters["Specifications"]["is_autographed"] = value
            elif 'Autograph Type' in key:
                product_parameters["Highlights"]["Autograph Type"] = value
            elif 'Size' in key:
