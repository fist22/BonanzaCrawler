...
def collect_data():
    ...
    prod_urls_file = open(constants.file_names["books"]["product"]).read().splitlines()
    ...
    ThreadPool().map(books_product_details.get_details, prod_url_info)
